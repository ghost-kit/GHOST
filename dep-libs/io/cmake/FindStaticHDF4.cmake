...
#MODIFIED BY JOSHUA MURPHY for finding only static libraries

# HDF4_LIBRARIES
# HDF4_EXTRA_LIBRARIES
find_package(JPEG)
find_library(HDF4_LIBRARY
            NAMES ${CMAKE_STATIC_LIBRARY_PREFIX}df${CMAKE_STATIC_LIBRARY_SUFFIX}
                  ${CMAKE_STATIC_LIBRARY_PREFIX}dfalt${CMAKE_STATIC_LIBRARY_SUFFIX}
            PATH_SUFFIXES hdf
            )

find_library(MFHDF4_LIBRARY
            NAMES   ${CMAKE_STATIC_LIBRARY_PREFIX}mfhdf${CMAKE_STATIC_LIBRARY_SUFFIX}
                    ${CMAKE_STATIC_LIBRARY_PREFIX}mfhdfalt${CMAKE_STATIC_LIBRARY_SUFFIX}
            PATH_SUFFIXES hdf
            )
...
if(HDF4_LIBRARIES)
        ...
        if(HDF4_WO_SZIP)
                ...
                find_library(SZIP_LIBRARIES
                            NAMES   ${CMAKE_STATIC_LIBRARY_PREFIX}sz${CMAKE_STATIC_LIBRARY_SUFFIX}
